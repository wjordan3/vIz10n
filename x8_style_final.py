...
train_data_dir = 'style/data/train'
validation_data_dir = 'style/data/validation'
nb_train_samples = 530*number_of_categories
...
#generates log files
tensorboard=TensorBoard(log_dir='./styleFinal_logs', histogram_freq=0, batch_size=batch_size, write_graph=True, write_grads=True, write_images=True, embeddings_freq=0, embeddings_layer_names='final_layer', embeddings_metadata='./stylefinal_metadata')

#ensure the best model is saved based on maximum validation accuracy attained during training rounds
best_model_checkpoint = ModelCheckpoint(filepath='style_final_best_model.h5', monitor='val_acc', verbose=0, save_best_only=True, save_weights_only=False, mode='auto', period=1)
...
model.save('style_model_final.h5')
